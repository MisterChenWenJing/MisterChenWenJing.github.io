...
案例中起始标签为 `<p>` 内容为 `Mr.Chen is handsome.` 闭合标签为 `</p>`。
...
除了并列放置标签以外，标签的内容也可以放置其他标签，这就构成了标签的嵌套。比如您想强调 Mr.Chen 的帅:

::: normal-demo 标签的嵌套

```html
<p>Mr.Chen is <strong>very</strong> handsome.</p>
```
